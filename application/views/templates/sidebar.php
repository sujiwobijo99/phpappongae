...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url("merge/index"); ?>">
        <div class="sidebar-brand-icon">
            <i class="fas fa-code-branch"></i>
        </div>
        <div class="sidebar-brand-text mx-3">Merge-Edu.id </div>
    </a>
